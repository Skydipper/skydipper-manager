...
class LoginModal extends PureComponent {
    ...
    setTimeout(() => {
      ...
      if (register) {
        ...
        this.userService
          ...
          .then(data => {
            setUser(data);
            // redirects the user to /manager once logged-in
  ...
  render() {
    const { email, password, repeatPassword, register, loading } = this.state;
                ...
                <form onSubmit={this.onSubmit}>
                  ...
                  {register && (
                    <Fragment>
                      <Field
                        ref={c => {
                          if (c) FORM_ELEMENTS.elements.repeatPassword = c;
                        }}
                        onChange={value => {
              ...
              <div className="column small-12 medium-5 medium-offset-2">
                ...
                <ul className="social-btn-list">
                  <li className="social-btn-item">
                    <a href="/auth/google" className="c-button -google -fullwidth">
                      Google
                    </a>
                  </li>
                  <li className="social-btn-item">
                    <a href="/auth/facebook" className="c-button -facebook -fullwidth">
                      facebook
                    </a>
                  </li>
                  <li className="social-btn-item">
                    <a href="/auth/twitter" className="c-button -twitter -fullwidth">
                      Twitter
                    </a>
                  </li>
                </ul>
