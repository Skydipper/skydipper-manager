...
class LayerPreviewComponent extends PureComponent {
  ...
  render() {
    const { managerLayerPreview, interactions } = this.props;
                          ...
                          !!added.length && {
                            interactivity:
                              l.provider === 'carto' || l.provider === 'cartodb'
                                ? added.map(o => o.column)
                                : true,
                            params: { update: added.map(o => o.column) },
                            events: {
                              click: e => {
                                if (this.props.setLayerInteraction)
                                  this.props.setLayerInteraction({ ...e, ...l });
                                if (this.props.setLayerInteractionLatLng)
                                  this.props.setLayerInteractionLatLng(e.latlng);
                              }
                            }
                          }}
