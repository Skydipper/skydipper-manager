...
class LayersForm extends React.Component {
  ...
  onSubmit(event) {
    ...
    setTimeout(() => {
      ...
      let { interactionConfig } = this.state.form;
      // Grab all the interactions from the redux store
      if (this.state.form.provider === 'cartodb') {
        interactionConfig = Object.assign({}, this.state.form.interactionConfig, {
      ...
      const { managerLayerPreview } = this.props;
      ...
      <form className="c-form c-layers-form" onSubmit={this.onSubmit} noValidate>
        ...
        {this.state.step === 1 && !this.state.loading && (
          <Step1
            ...
            id={this.state.id}
            layerPreview={this.props.managerLayerPreview}
